const CACHE='protein-finds-v1';
const SHELL=['./','./index.html','./styles.css','./pwa.css','./data.js','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
